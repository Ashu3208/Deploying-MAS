  ...
  if (req.isAuthenticated()) {
    if (process.env.SUPERUSER === "true") {
      ...
      res.render("student/mess-menu", {
        mob: await Item.find({ code: "110" }),
        mobe: await Item.find({ code: "111" }),
        mol: await Item.find({ code: "120" }),
        mole: await Item.find({ code: "121" }),
        mod: await Item.find({ code: "130" }),
        mode: await Item.find({ code: "131" }),
        tub: await Item.find({ code: "210" }),
        tube: await Item.find({ code: "211" }),
        tul: await Item.find({ code: "220" }),
        tule: await Item.find({ code: "221" }),
        tud: await Item.find({ code: "230" }),
        tude: await Item.find({ code: "231" }),
        web: await Item.find({ code: "310" }),
        webe: await Item.find({ code: "311" }),
        wel: await Item.find({ code: "320" }),
        wele: await Item.find({ code: "321" }),
        wed: await Item.find({ code: "330" }),
        wede: await Item.find({ code: "331" }),
        thb: await Item.find({ code: "410" }),
        thbe: await Item.find({ code: "411" }),
        thl: await Item.find({ code: "420" }),
        thle: await Item.find({ code: "421" }),
        thd: await Item.find({ code: "430" }),
        thde: await Item.find({ code: "431" }),
        frb: await Item.find({ code: "510" }),
        frbe: await Item.find({ code: "511" }),
        frl: await Item.find({ code: "520" }),
        frle: await Item.find({ code: "521" }),
        frd: await Item.find({ code: "530" }),
        frde: await Item.find({ code: "531" }),
        sab: await Item.find({ code: "610" }),
        sabe: await Item.find({ code: "611" }),
        sal: await Item.find({ code: "620" }),
        sale: await Item.find({ code: "621" }),
        sad: await Item.find({ code: "630" }),
        sade: await Item.find({ code: "631" }),
        sub: await Item.find({ code: "710" }),
        sube: await Item.find({ code: "711" }),
        sul: await Item.find({ code: "720" }),
        sule: await Item.find({ code: "721" }),
        sud: await Item.find({ code: "730" }),
        sude: await Item.find({ code: "731" }),
      });
    }
  } else {
    res.redirect("/login");
  ...
  if (req.isAuthenticated()) {
    if (process.env.SUPERUSER === "true") {
      res.render("manager/rebateApproval.ejs", {
        rebates: await Rebate.find({ status: "pending" }),
      });
    } else {
      res.redirect("/");
    }
